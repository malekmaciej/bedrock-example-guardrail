...
class BedrockGuardrailClient:
    ...
    def __init__(
        ...
        self.inference_profile_id = inference_profile_id or os.getenv(
    ...
    def invoke_model(
        ...
        try:
            ...
            if (
                ...
                or "guardrail" in error_message.lower()
            ):
                return {
                    "success": False,
...
def main():
    ...
    client = BedrockGuardrailClient(region="eu-west-1")
    ...
    print("-" * 80)
    prompt2 = (
        "My email is john.doe@example.com and my phone is 555-1234. Can you help me?"
    )
